...
def eval_zero_shot(model_name, save_model, task_list=["boolq","rte","hellaswag","winogrande","arc_challenge","arc_easy","openbookqa"], 
    ...
    print(task_names)
    model_args = f"pretrained={save_model},cache_dir=./llm_weights,trust_remote_code=True"
    limit = None 
    if "70b" in model_name or "65b" in model_name:
        limit = 2000
    if use_accelerate:
        model_args = f"pretrained={save_model},cache_dir=./llm_weights,use_accelerate=True,trust_remote_code=True"
