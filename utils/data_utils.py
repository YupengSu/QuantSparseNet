...
def get_c4(nsamples, seed, seqlen, tokenizer):
    traindata = load_dataset(
        '/zju_0038/yupengsu/Datasets/allenai-c4', data_files={'train': 'c4-train.00000-of-01024.json.gz'}, split='train', trust_remote_code=True
    )
    valdata = load_dataset(
        '/zju_0038/yupengsu/Datasets/allenai-c4', data_files={'validation': 'c4-validation.00000-of-00008.json.gz'}, split='validation', trust_remote_code=True
    )
